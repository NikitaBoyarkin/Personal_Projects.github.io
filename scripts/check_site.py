...
def check_required_pages() -> int:
    ...
    required = [
        ...
        DIST / "projects" / "volta" / "funnel" / "index.html",
        DIST / "projects" / "volta" / "ab" / "index.html",
        DIST / "projects" / "volta" / "retention" / "index.html",
        DIST / "projects" / "volta" / "segmentation" / "index.html",
