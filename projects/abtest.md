...
Фреймворк для проведения **A/B тестов** с автоматическим расчетом статистической значимости и визуализацией результатов.

Обеспечивает надежную оценку эффективности изменений и помогает принимать **data-driven** решения.
