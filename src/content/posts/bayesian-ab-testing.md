...
Пост о том, почему команда отказалась от частотного p-value в пользу байесовского вывода. Разбираются механика peeking, метрика Probability of Direction и минимальный пример на PyMC. Читатель получает сравнение частотного и байесовского подходов и практические критерии выбора между ними — в зависимости от длительности эксперимента, числа метрик и требований к интерпретации.
