...
Считалась воронка онбординга до первого продуктивного действия. Главная утечка оказалась в **KYC** — этапе верификации. Гипотеза: слишком длинная форма и отсутствие промежуточного подтверждения. Изменение флоу (KYC разбит на шаги с прогрессом) подняло конверсию на **+5.72pp при Z = 5.82, p < 0.0001**.

Прикидка эффекта: при реалистичной аудитории это ≈ **€656K/год** при ROI около 44×. Цифры синтетические, но механика оценки — та же, что для реального фикса: конверсия × число пользователей × LTV.
