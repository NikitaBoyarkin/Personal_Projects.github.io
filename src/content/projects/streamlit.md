...
related:
  - /projects/supabase/
caseStudy:
  problem: "На собеседованиях по product-аналитике ожидают рассуждений в рамках всей AARRR-рамки — acquisition, activation, retention, revenue — но большинство портфолио показывают одну метрику изолированно."
