...
**Red flag (F1–F7)**:
Доверие-ломающий артефакт в системе портфолио: приватный флагманский репо, карточка на заглушку, пустое репо, сломанное имя папки, пустой README при живом коде. Полный перечень — PRD v5 §2.2.
